...
SELECT payment_id, amount, payment_date FROM payment WHERE DATE(payment_date) IN (DATE('2005/05/25'), DATE('2005/05/27'), DATE('2005/05/29'));
...
SELECT * from payment WHERE payment_date BETWEEN '2005-05-25' AND '2005-05-25 23:59:59';
